...
public class DegatPhysiqueDto {
	...
	public DegatPhysiqueDto(Long id, String descriptionDegat, String estimationPrixDegat, Long idAccident) {
		super();
		this.id = id;
		this.descriptionDegat = descriptionDegat;
		this.estimationPrixDegat = estimationPrixDegat;
